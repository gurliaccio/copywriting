    ...
    <div class="col-lg-1 col-centered"></div>
        ...
        <div class="row">
            <div class="col-lg-12 col-centered">
                ...
                <br>
                <p style="color:#f5f5f5" class="wow fadeInDown" data-wow-duration="3s">&nbsp;Current fascinations include AI and blockchain, the future of healthcare technology, old stand-up comedy, my electronic drum set, the unreal island of &nbsp;Sardinia, and all the exotic food on Buford Highway.</p>
